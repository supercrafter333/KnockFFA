...
class Languages
{
    ...
    {
        $rawLang = KnockFFA::getInstance()->getConfig()->get("language");
        if (strtolower($rawLang) == "custom") {
            KnockFFA::getInstance()->saveResource("languages/messages.yml");
            return new Config(KnockFFA::getInstance()->getDataFolder() . "languages/messages.yml", Config::YAML);
        }
        if (isset(self::$languages[$rawLang]) && file_exists(KnockFFA::getInstance()->getFile2() . "resources/languages/" . $rawLang . ".yml")) return new Config(KnockFFA::getInstance()->getFile2() . "resources/languages/" . $rawLang . ".yml", Config::YAML);
    ...
    public static function getLanguage(): string
    {
        ...
        if (isset(self::$languages[$rawLang]) && file_exists(KnockFFA::getInstance()->getFile2() . "resources/languages/" . $rawLang . ".yml")) return $rawLang;
    ...
    {
        return new Config(KnockFFA::getInstance()->getFile2() . "resources/languages/" . self::LANG_en_BE . ".yml", Config::YAML);
    }
